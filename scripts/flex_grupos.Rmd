...
investigadores_general <- 
  investigadores_general |> 
  separate_rows(grupo, sep = "; ") |> 
  right_join(capitulos_2016_2020_author |> 
               separate_rows(grupo, sep = "; "), 
             by = c("integrantes" = "autores", 
                    "grupo" = "grupo")) |> 
  right_join(libros_2016_2020_author |> 
               separate_rows(grupo, sep = "; "), 
             by = c("integrantes" = "Autores", 
                    "grupo" = "grupo")) |> 
  right_join(software_2016_2020_author |> 
               separate_rows(grupo, sep = "; "), 
             by = c("integrantes" = "autores", 
                    "grupo" = "grupo"))  |> 
  right_join(trabajo_2016_2020_author |> 
               separate_rows(grupo, sep = "; "), 
             by = c("integrantes" = "tutor_coautor", 
                    "grupo" = "grupo")) |> 
  right_join(innovacion_2016_2020_author |> 
               separate_rows(grupo, sep = "; "), 
             by = c("integrantes" = "autores", 
                    "grupo" = "grupo")) |> 
