...
grupos_general |> 
  ...
  datatable(options = list(pageLength = 15),
            escape = FALSE,
            colnames = c("Grupo", "Clasificaci髇", "Cantidad Articulos",
                         "Departamento","GrupLAC", 
                         "Fecha Creaci髇", "Lider", "Email", 
                         "羠ea de Conocimiento"))
```
...
investigadores_general |> 
  ...
  datatable(options = list(pageLength = 15),
            escape = FALSE,
            colnames = c("Investigador", "Categoria", "Producci髇", "H index", "Formaci髇",
...
articulos_unicos_2016_2020 |>
  ...
  datatable(options = list(pageLength = 15),
            escape = FALSE,
            colnames = c("Grupo", "Categor铆a", "Tipo producto",
                         "T铆tulo", "Pa铆s revista", "Revista", 
                         "ISSN","Casiflicaci髇 Revista", "A駉", "Volumen",
                         "Fasc",
                         "Paginas", "DOI", "Autores"))
```
...
paises |> 
  ...
  datatable(options = list(pageLength = 20), 
            colnames = c('Pa铆s revista', 'Cantidad', 'Porcentajes')) 
```
### Revistas
```{r}
...
fig3 <- fig3 %>% layout(title = "Producci贸n articulos",
         xaxis = list(title = ""),
         yaxis = list(title = ""))
...
### Formacion Investigadores general
```{r}
...
### Formacion investigadores por grupo
```{r}
