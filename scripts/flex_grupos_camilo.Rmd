...
grupos_general |> 
  ...
  datatable(options = list(pageLength = 15),
            escape = FALSE,
            colnames = c("Grupo", "Clasificaci髇", "Cantidad Articulo",
...
investigadores_general |> 
  ...
  datatable(options = list(pageLength = 15),
            escape = FALSE,
            colnames = c("Investigador", "Categoria", "Producci贸n", "H index", "Formaci贸n",
...
data6 <- merge(data4, data5, by = c("grupo", "categoria"), all = TRUE)
