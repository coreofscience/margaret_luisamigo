...
```{r}
grupos_general |> 
  select(grupo, clasificacion, sum_papers, departamento , url, fecha_creacion, lider, email, area_conocimiento_1)
  datatable(options = list(pageLength = 15),
            escape = FALSE,
            colnames = c("Grupo", "Clasificación", "Cantidad Articulo", "Cantidad investigadores",
                         "GrupLAC", "Fecha Creación", "Lider", "Email", "Área de Conocimiento"))
```
